 ...
 * OPL 22.1.0.0 Model
 * Author: User
 * Creation Date: Feb 1, 2024 at 8:25:07 PM
 *********************************************/
int n=...;
range cities=1..n;
//range i=1..n;
...
execute{
var after = new Date();
var f1=new IloOplOutputFile("E:/TSP_ILP/timeLP.txt");
f1.writeln(" Time=",(after.getTime()-temp)/1000);
}
execute{
/*var f2=new IloOplOutputFile("E:/TSP_ILP/pathlp1.txt");
//f2.writeln("1");
var i=1;
var j=1;
//var k=1;
...
f2.close();*/
var f=new IloOplOutputFile("E:/TSP_ILP/distLP.txt");
